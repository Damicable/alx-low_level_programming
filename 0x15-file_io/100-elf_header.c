 ...
 * @e_ident: An array containing the ELF version pointer.
 */
 ...
 * @e_ident: An array containing the ELF ABI version pointer
 */
 ...
 * @e_ident: An array containing the ELF class pointer
 */
 ...
 *
 * Description: incase file cannot be closed - exit code 98.
 */
